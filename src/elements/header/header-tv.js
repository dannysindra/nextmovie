    ...
    <Root>
      ...
      <Details>
        <Metadata>
          <Meta
            icon={
              <FaCalendar color={theme.colors.colorSecondary} size="0.8em" />
            }
            label={'Last air date'}
            value={lastAirDate}
          />
          <Meta
            icon={<FaClock color={theme.colors.backgroundAlt} size="0.8em" />}
            label={'Episode runtime'}
            value={runtime}
          />
          <Meta
            icon={<FaTv color={theme.colors.positive} size="0.8em" />}
            label="Number of seasons"
            value={totalSeasons}
          />
          <Meta
            icon={<FaHeart color={theme.colors.colorPrimary} size="0.8em" />}
            label={'Votes'}
            value={votes}
          />
        </Metadata>
